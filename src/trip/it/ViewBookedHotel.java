...
public class ViewBookedHotel extends JFrame implements ActionListener{
  ...
  ViewBookedHotel(String username){
      ...
      lblsurname.setBounds(30, 290, 150, 25);
      add(lblsurname);
      
      JLabel labelsurname = new JLabel();
      labelsurname.setBounds(220, 290, 150, 25);
      add(labelsurname);
      
      JLabel lblname = new JLabel("Name");
      lblname.setBounds(30, 330, 150, 25);
      add(lblname);
      
      JLabel labelname = new JLabel();
      labelname.setBounds(220, 330, 150, 25);
      add(labelname);
      ...
      ImageIcon il = new ImageIcon(ClassLoader.getSystemResource("icons/phy.png"));
